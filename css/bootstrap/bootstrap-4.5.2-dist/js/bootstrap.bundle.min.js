...
!(function(t, e) {
  ...
  function R(t, e) {
    ...
    if ((t !== l && e !== l) || i.contains(o))
      return 'BODY' === (a = (s = l).nodeName) || ('HTML' !== a && P(s.firstElementChild) !== s)
        ? P(l)
        : l;
    var c = F(t);
            ...
            var c = e.priority,
              ...
              u = {
                primary: function(t) {
                  var n = h[t];
                  return (
                    h[t] < l[t] && !e.escapeWithReference && (n = Math.max(h[t], l[t])), V({}, t, n)
                  );
                },
        ...
        (n._getOffset = function() {
          ...
          return (
            'function' == typeof this._config.offset
              ? (e.fn = function(e) {
                  return (
                    (e.offsets = o({}, e.offsets, t._config.offset(e.offsets, t._element) || {})), e
                  );
                })
        ...
        s = function(t, n) {
          ...
          a.forEach(function(t) {
            (function(t, e) {
              ...
              if (-1 !== e.indexOf(n))
                return (
                  -1 === Mt.indexOf(n) || Boolean(t.nodeValue.match(qt) || t.nodeValue.match(Qt))
                );
              for (
      ...
      return (
        ...
        (n._getOffset = function() {
          ...
          return (
            'function' == typeof this.config.offset
              ? (e.fn = function(e) {
                  return (
                    (e.offsets = o({}, e.offsets, t.config.offset(e.offsets, t.element) || {})), e
                  );
                })
        ...
        (n._getConfig = function(t) {
          ...
          return (
            ...
            'number' ==
              typeof (t = o({}, this.constructor.Default, n, 'object' == typeof t && t ? t : {}))
